...
```{r}
parcoord(clean_data, col=var.outliers.mah.mcd, var.label=TRUE, main="PCP for Boston Housing")
```
...
andrews(andrews.matrix, clr=15, ymax=6, main="Andrews' Plot for Boston Housing")
```
